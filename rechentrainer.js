...
var view = {
  ...
  setTrue: function () {
    this.labelTruth.innerText = "Richtig!";
    this.labelTruth.classList.remove("alert-danger");
    this.labelTruth.classList.add("alert-success");
  },

  setFalse: function () {
    this.labelTruth.innerText = "Leider falsch";
    this.labelTruth.classList.remove("alert-success");
    this.labelTruth.classList.add("alert-danger");
  },

  // neither true nor false
  setNeitherNor: function () {
    this.labelTruth.innerText = "";
    this.labelTruth.classList.remove("alert-success");
    this.labelTruth.classList.remove("alert-danger");
  }
};
